...
public class Eventsnowlogin {
	public static void main(String[] args) throws InterruptedException{
	executeEventsnowlogin(Util.getChromeDriver());
}
public static void executeEventsnowlogin(WebDriver driver) throws InterruptedException
	 {
